  ...
  return (
    <footer className='bg-black'>
      <div className='py-12 px-8 text-white'>
        <div className='flex flex-col md:flex-row md:justify-between md:border-b md:border-[#6C7275]'>
          <div className='flex flex-col text-center md:flex-row my-auto'>
            <p className='font-poppins font-medium text-2xl mb-8 md:pr-8 md:my-auto md:border-r md:border-[#6C7275]'>
              3legant<span className='text-[#6C7275]'>.</span>
            </p>
            <a href='' className='md:pl-8 my-auto'>
        ...
        <div className='flex flex-col md:flex-row-reverse md:justify-between md:mt-4'>
          ...
          <div className='flex flex-col md:flex-row-reverse'>
            <div className='flex justify-center font-poppins font-semibold text-xs text-[#ffff]mt-8 md:my-auto'>
              <a href='' className='mr-7'>
                Privacy Policy
              </a>
              <a href=''>Terms of Use</a>
            </div>
            <p className='text-[#E8ECEF] text-xs font-normal text-center mt-7 md:mr-7 md:my-auto'>
