  ...
  return (
    <section className='mt-10 mx-8 2xl:mx-60'>
      <div className='flex container flex-col sm:flex-row'>
        <div className='w-1/2 h-auto bg-[#F3F5F7] mr-4 max-sm:w-full max-sm:mb-4'>
          <div className='m-4'>
        ...
        <div className='w-1/2 flex flex-col max-sm:w-full'>
          <div className='h-1/2 bg-[#F3F5F7] flex justify-between mb-4'>
          ...
          <div className='h-1/2 bg-[#F3F5F7] flex justify-between'>
            <div className='flex justify-end items-end'>
              <div className='cotainer m-4'>
