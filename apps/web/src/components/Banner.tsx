  ...
  return (
    <section className='mt-12'>
      <div className='flex flex-col lg:flex-row'>
        ...
        />
        <div className='bg-[#F3F5F7] lg:w-1/2'>
          <div className='my-14 mx-8 lg:my-40 lg:ml-20'>
            <p className='text-[377DFF] font-inter text-base font-bold'>
              SALE UP TO 35% OFF
            </p>
            <h5 className='my-4 lg:text-5xl'>HUNDREDS of New lower prices!</h5>
            <p className='font-inter text--[#FFAB00] text-base font-normal mb-6 lg:text-xl'>
