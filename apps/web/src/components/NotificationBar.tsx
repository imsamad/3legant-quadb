...
const NotificationBar = () => {
  ...
  return (
    <>
      {isVisible && (
        <div className='sticky top-0 z-50 w-full h-10 flex justify-center items-center py-2 bg-[#F3F5F7]'>
          <img
            src={ticket}
            alt='ticket-percent'
          ...
          <Link
            to='/shop'
            className='border-b border-[377DFF] hidden sm:flex items-center'
          >
            <p className='font-inter font-medium text-[377DFF] text-sm'>
              Shop Now
            </p>
